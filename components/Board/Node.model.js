 ...
 */
let node = [
	{ key: '00', location: { x: 0, y: 0 }, winningLogic: [['R', 'R'], ['D', 'D']], R: { vertex: null, path: findEdge('0003') }, D: { vertex: null, path: findEdge('0030') }, U: { vertex: null, path: null }, L: { vertex: null, path: null } },
	{ key: '03', location: { x: 3, y: 0 }, winningLogic: [['R', 'L'], ['D', 'D']], R: { vertex: null, path: findEdge('0306') }, D: { vertex: null, path: findEdge('0313') }, U: { vertex: null, path: null }, L: { vertex: null, path: findEdge('0003') } },
	{ key: '06', location: { x: 6, y: 0 }, winningLogic: [['L', 'L'], ['D', 'D']], R: { vertex: null, path: null }, D: { vertex: null, path: findEdge('0636') }, U: { vertex: null, path: null }, L: { vertex: null, path: findEdge('0306') } },
	...
	{ key: '30', location: { x: 0, y: 3 }, winningLogic: [['R', 'R'], ['D', 'U']], R: { vertex: null, path: findEdge('3031') }, D: { vertex: null, path: findEdge('3060') }, U: { vertex: null, path: findEdge('0030') }, L: { vertex: null, path: null } },
	...
	{ key: '34', location: { x: 4, y: 3 }, winningLogic: [['R', 'R'], ['D', 'U']], R: { vertex: null, path: findEdge('3435') }, D: { vertex: null, path: findEdge('3444') }, U: { vertex: null, path: findEdge('2434') }, L: { vertex: null, path: null } },
	...
	{ key: '44', location: { x: 4, y: 4 }, winningLogic: [['L', 'L'], ['U', 'U']], R: { vertex: null, path: null }, D: { vertex: null, path: null }, U: { vertex: null, path: findEdge('3444') }, L: { vertex: null, path: findEdge('4344') } },
	{ key: '51', location: { x: 1, y: 5 }, winningLogic: [['R', 'R'], ['U', 'U']], R: { vertex: null, path: findEdge('5153') }, D: { vertex: null, path: null }, U: { vertex: null, path: findEdge('3151') }, L: { vertex: null, path: null } },
	{ key: '53', location: { x: 3, y: 5 }, winningLogic: [['R', 'L'], ['D', 'U']], R: { vertex: null, path: findEdge('5355') }, D: { vertex: null, path: findEdge('5363') }, U: { vertex: null, path: findEdge('4353') }, L: { vertex: null, path: findEdge('5153') } },
	...
	{ key: '60', location: { x: 0, y: 6 }, winningLogic: [['R', 'R'], ['U', 'U']], R: { vertex: null, path: findEdge('6063') }, D: { vertex: null, path: null }, U: { vertex: null, path: findEdge('3060') }, L: { vertex: null, path: null } },
	...
	{ key: '66', location: { x: 6, y: 6 }, winningLogic: [['L', 'L'], ['U', 'U']], R: { vertex: null, path: null }, D: { vertex: null, path: null }, U: { vertex: null, path: findEdge('3666') }, L: { vertex: null, path: findEdge('6366') } },
]
